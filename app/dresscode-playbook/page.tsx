          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="border border-gray-200 rounded-2xl p-8 flex flex-col">
              ...
              <button
                ...
                disabled={cartAdded}
                className="w-full inline-flex items-center justify-center font-semibold rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-business-gold focus:ring-offset-2 bg-business-gold text-business-darkNavy hover:bg-[#b89550] disabled:opacity-70 px-6 py-3.5 text-sm"
              >
                {cartAdded ? (
                  <>
